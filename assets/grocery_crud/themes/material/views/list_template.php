<?php
	...
	//$this->set_css($this->default_theme_path.'/material/css/demo_table_jui.css');
	//$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
	$this->set_css($this->default_theme_path.'/material/css/material.css');
	//$this->set_css($this->default_theme_path.'/material/css/jquery.dataTables.css');
	//$this->set_css($this->default_theme_path.'/material/extras/TableTools/media/css/TableTools.css');
	...
	$this->set_js_lib($this->default_theme_path.'/material/js/jquery.dataTables.min.js');
	$this->set_js($this->default_theme_path.'/material/js/datatables-extras.js');
	$this->set_js($this->default_theme_path.'/material/js/datatables.js');
	$this->set_js($this->default_theme_path.'/material/extras/TableTools/media/js/ZeroClipboard.js');
	$this->set_js($this->default_theme_path.'/material/extras/TableTools/media/js/TableTools.min.js');
...
<?php }?>
	...
	<?php }
	?></div>
	<div class="dataTablesContainer row">
		<?php if(!$unset_add){?>
			<div class="col s6">
				<a role="button" class="btn green " href="<?php echo $add_url?>">
