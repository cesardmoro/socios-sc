...
class Admin extends MY_Controller {
	...
	public function confirmar_pago_festival($id){
		...
		if($inscripcion->estado_pago != null ){ 
			...
			$body = $this->load->view('festival/email-confirmacion', array('inscripcion' => $inscripcion, 'packs' => array('Pre-Reserva pack completo socios', 'Pack completo', 'Pack acompañante', 'Pack fiesta de cierre', 'Tour cervecero')), true); 
			$this->email->from('socios@somoscerveceros.com.ar', 'Somos Cerveceros');
