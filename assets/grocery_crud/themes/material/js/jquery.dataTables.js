...
(/** @lends <global> */function($, window, document, undefined) {
	...
	$.extend( DataTable.ext.oJUIClasses, DataTable.ext.oStdClasses, {
		/* Two buttons buttons */
		"sPagePrevEnabled": "fg-button btn ui-state-default ui-corner-left",
		"sPagePrevDisabled": "fg-button btn ui-state-default ui-corner-left ui-state-disabled",
		"sPageNextEnabled": "fg-button btn ui-state-default ui-corner-right",
		"sPageNextDisabled": "fg-button btn ui-state-default ui-corner-right ui-state-disabled",
		"sPageJUINext": "ui-icon ui-icon-circle-arrow-e",
		"sPageJUIPrev": "ui-icon ui-icon-circle-arrow-w",
		
		/* Full numbers paging buttons */
		"sPageButton": "fg-button btn ui-state-default",
		"sPageButtonActive": "fg-button btn ui-state-default ui-state-disabled",
		"sPageButtonStaticDisabled": "fg-button btn ui-state-default ui-state-disabled",
